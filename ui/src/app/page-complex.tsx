          ...
          <div className="mx-auto max-w-2xl">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              ...
              <Button
                ...
                data-cy="run-setup-wizard-button"
              >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card className="@container/card" data-cy="dashboard-statistics-card">
            <CardHeader>
              ...
              <CardTitle className="text-3xl font-semibold mt-2" data-cy="dashboard-binds-count">
                {binds?.length || 0}
              </CardTitle>
              <Link
                href="/listeners"
          ...
          <Card className="@container/card" data-cy="dashboard-statistics-card">
            <CardHeader>
              ...
              <CardTitle
                ...
                data-cy="dashboard-listeners-count"
              >
                {getTotalListeners()}
              </CardTitle>
              <Link
          ...
          <Card className="@container/card" data-cy="dashboard-statistics-card">
            <CardHeader>
              ...
              <CardTitle className="text-3xl font-semibold mt-2" data-cy="dashboard-routes-count">
                {getTotalRoutes()}
              </CardTitle>
              <Link
                href="/routes"
          ...
          <Card className="@container/card" data-cy="dashboard-statistics-card">
            <CardHeader>
              ...
              <CardTitle className="text-3xl font-semibold mt-2" data-cy="dashboard-backends-count">
                {getTotalBackends()}
              </CardTitle>
              <Link
                href="/backends"
